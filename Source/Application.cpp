...
: mWindow(sf::VideoMode(1024, 768), "SFML Demo", sf::Style::Close)
, mTextures()
, mFonts()
, mMusic()
, mSounds()
, mKeyBinding1(1)
, mKeyBinding2(2)
, mDifficulty(State::Hard)
, mStateStack(State::Context(mWindow, mTextures, mFonts, mMusic, mSounds, mKeyBinding1, mKeyBinding2, mDifficulty))
, mStatisticsText()
...
, mStatisticsNumFrames(0)
{
	...
	mFonts.load(Fonts::Title, 	"Media/Fonts/SegoePrint.ttf");
